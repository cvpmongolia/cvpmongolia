...
function generateAdvice(answers) {
  ...
  if (q2) {
    advice.priority1.push({
      ...
      content: `Daily TF маань илүү том TF-йн lvl(1)/zone(2) руу орж ирсэн учир Daily TF-ийн зүг чиг ямар байхаас хамааралгүй ойрын хугацаанд Daily TF савалт руу орж Flat үүснэ гэсэн хүлээлттэй арилжина уу. Тэр нь Daily TF-ийн lvl-үүд, zone(2)-ууд ерөнхий хүлээлтийн хэмжээнд шууд break орохгүй гэж тооцоолоод арилжаа хийх хэрэгтэй гэсэн үг. Break орж магадгүй гэж бодох биш break орохгүй байх гэж бодож арилжаагаа хийнэ. Тухайн логикийн дагуу том TF болох +4/+3 дээр, өөр дээр нь lvl ба zone-ын Reaction ороод зах зээл аль нэг тийш болох хүртэл арилжина.`
    });
  }
